...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the VynxDesk network..."),
        ...
        ("install_tip", "Due to UAC, VynxDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install VynxDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant VynxDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant VynxDesk \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "Configure Custom Server"),
        ("Enter Remote ID", "Enter remote ID"),
        ("empty_sessions_tip", "Enter a remote ID above to start connecting"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow VynxDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [VynxDesk Input] service."),
        ...
        ("doc_mac_permission", "https://vynx.com.tr/#guide"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next VynxDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant VynxDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant VynxDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running VynxDesk."),
        ...
        ("View Mode", "View mode"),
        ("verify_vynxdesk_password_tip", "Verify VynxDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use VynxDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_vynxdesk_server_pro_to_{}_tip", "Please upgrade VynxDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://vynx.com.tr/#guide"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent VynxDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by VynxDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if VynxDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep VynxDesk background service"),
        ...
        ("upgrade_remote_vynxdesk_client_to_{}_tip", "Please upgrade the VynxDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, VynxDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, VynxDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, VynxDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: VynxDesk server OSS doesn't include this feature."),
        ...
        ("Observing the reported session", ""),
        ("Reported delay", ""),
        ("Lowest reported display FPS", ""),
        ("Target bitrate", ""),
        ("Report preview", ""),
        ...
        ("Copy report", ""),
        ("Report copied", ""),
        ("Copy failed. Select the report text or try again.", ""),
    ].iter().cloned().collect();
}
