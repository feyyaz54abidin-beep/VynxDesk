...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("empty_sessions_tip", "Uzak masaüstüne bağlanmak için yukarıya bir ID girin"),
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, VynxDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, VynxDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için VynxDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için VynxDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("setup_server_tip", "Özel Sunucu Yapılandır"),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, VynxDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [VynxDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep VynxDesk background service", "VynxDesk arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki VynxDesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show VynxDesk", "VynxDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için VynxDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için VynxDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan VynxDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_vynxdesk_password_tip", "VynxDesk parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden VynxDesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_vynxdesk_server_pro_to_{}_tip", "Lütfen VynxDesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, VynxDesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "VynxDesk tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca VynxDesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "VynxDesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About VynxDesk", "VynxDesk Hakkında"),
        ...
        ("upgrade_remote_vynxdesk_client_to_{}_tip", "Lütfen uzak tarafta VynxDesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, VynxDesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda VynxDesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, VynxDesk artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: VynxDesk sunucu OSS'si bu özelliği içermemektedir."),
        ...
        ("Your world.", "Senin dünyan."),
        ("Your control.", "Senin kontrolün."),
        ...
        ("Connection doctor", "Bağlantı tanılama"),
        ("Retry connection doctor", "Tanılamayı yeniden aç"),
        ("Waiting for observations", "Gözlem verileri bekleniyor"),
        ("No current diagnostic data is available. This is not a successful connection test.", "Güncel tanılama verisi yok. Bu durum bağlantı testinin başarılı olduğu anlamına gelmez."),
        ("Session disconnected", "Oturum bağlantısı kesildi"),
        ("The observer reports a disconnection. The cause is not known from this report.", "Gözlemci bağlantının kesildiğini bildiriyor. Bu rapor kesilme nedenini belirleyemiyor."),
        ("Observations are stale", "Gözlem verileri güncel değil"),
        ("No recent diagnostic event was received. Cached measurements are hidden; this does not prove a disconnection.", "Yakın zamanda tanılama olayı alınmadı. Önbellekteki ölçümler gizlendi; bu durum bağlantının kesildiğini kanıtlamaz."),
        ("Connection in progress", "Bağlantı kuruluyor"),
        ("Wait for the session to connect. No failure cause has been established.", "Oturumun bağlanmasını bekleyin. Henüz bir hata nedeni belirlenmedi."),
        ("Connection security is unverified", "Bağlantı güvenliği doğrulanmadı"),
        ("Verify the intended peer and server identity before sharing sensitive data. This status alone does not establish whether traffic is encrypted.", "Hassas veri paylaşmadan önce hedef cihaz ve sunucu kimliğini doğrulayın. Bu durum tek başına trafiğin şifreli olup olmadığını belirlemez."),
        ("Security status is unknown", "Güvenlik durumu bilinmiyor"),
        ("The observer did not provide a recognized security state. Do not treat an unknown value as verified.", "Gözlemci tanınan bir güvenlik durumu bildirmedi. Bilinmeyen değeri doğrulanmış kabul etmeyin."),
        ("View-only mode is enabled", "Yalnızca görüntüleme modu açık"),
        ("This session is configured for viewing. Change control permissions only with the remote user or administrator.", "Bu oturum görüntüleme için yapılandırılmış. Kontrol izinlerini yalnızca uzak kullanıcı veya yöneticiyle birlikte değiştirin."),
        ("Keyboard permission is disabled", "Klavye kontrol izni kapalı"),
        ("The current session does not permit keyboard control. Ask the remote user or administrator to review its permissions.", "Mevcut oturum klavye kontrolüne izin vermiyor. Uzak kullanıcıdan veya yöneticiden izinleri incelemesini isteyin."),
        ("Using a relay", "Relay üzerinden bağlanıldı"),
        ("Relay routing is normal and is not a failure by itself. Compare measured quality before changing network settings.", "Relay üzerinden yönlendirme normaldir ve tek başına hata değildir. Ağ ayarlarını değiştirmeden önce ölçülen kaliteyi karşılaştırın."),
        ("High reported latency", "Bildirilen gecikme yüksek"),
        ("The latest reported delay is at least 200 ms. Try a lower image-quality setting and compare; this is not an end-to-end input-latency measurement.", "Son bildirilen gecikme en az 200 ms. Görüntü kalitesini düşürüp karşılaştırın; bu değer uçtan uca girdi gecikmesi ölçümü değildir."),
        ("Few frames reported", "Bildirilen kare sayısı düşük"),
        ("A static screen can produce few frames. Check a changing image before concluding that capture or the network has failed.", "Sabit bir ekran az sayıda kare üretebilir. Yakalama veya ağ hatası olduğu sonucuna varmadan önce hareketli bir görüntüyü kontrol edin."),
        ("Observation limits", "Gözlemin sınırları"),
        ("Recent events may contain last-known measurements. This report does not prove that an application accepted input, that every component is healthy, or that licensing is enforced.", "Yeni olaylar son bilinen ölçümleri içerebilir. Bu rapor uygulamanın girdiyi kabul ettiğini, her bileşenin sağlıklı olduğunu veya lisans kontrolünün uygulandığını kanıtlamaz."),
        ("Review these observations", "Bu gözlemleri inceleyin"),
        ("Observing the reported session", "Bildirilen oturum gözlemleniyor"),
        ("Reported delay", "Bildirilen gecikme"),
        ("Lowest reported display FPS", "Ekranlar arasında bildirilen en düşük FPS"),
        ("Target bitrate", "Hedef bit hızı"),
        ("Report preview", "Rapor önizlemesi"),
        ("This frozen report includes only allowed status values and numeric diagnostics. No peer IDs, addresses, credentials or screen content are included. Nothing is uploaded.", "Bu sabitlenmiş rapor yalnızca izin verilen durum değerlerini ve sayısal tanılamaları içerir. Cihaz kimlikleri, adresler, kimlik bilgileri veya ekran içeriği içermez. Hiçbir veri yüklenmez."),
        ("Copying uses the system clipboard. Clipboard synchronization or other apps may share its contents.", "Kopyalama sistem panosunu kullanır. Pano eşitlemesi veya diğer uygulamalar içeriği paylaşabilir."),
        ("Preview report", "Raporu önizle"),
        ("Back to observations", "Gözlemlere dön"),
        ("Copy report", "Raporu kopyala"),
        ("Report copied", "Rapor kopyalandı"),
        ("Copy failed. Select the report text or try again.", "Kopyalanamadı. Rapor metnini seçin veya tekrar deneyin."),
    ].iter().cloned().collect();
}
