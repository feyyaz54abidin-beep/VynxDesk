...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/release/service ./build/macos/Build/Products/Release/VynxDesk.app/Contents/MacOS/')
    '''
    system2(
...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/vynxdesk.exe')
    os.chdir('../..')
    ...
    os.rename('./rustdesk_portable.exe', f'./vynxdesk-{version}-install.exe')
    print(
        f'output location: {os.path.abspath(os.curdir)}/vynxdesk-{version}-install.exe')
