<p align="center">
  <img src="res/logo-header.svg" alt="VynxDesk remote desktop"><br>
...
VynxDesk is a branded derivative of the open-source RustDesk remote desktop client.
The internal Rust crate and library names remain `rustdesk`/`librustdesk` for protocol
and build compatibility; distributed product names and package identifiers use VynxDesk.

This source tree is licensed under GNU AGPL-3.0-or-later. See [LICENCE](LICENCE) and
[NOTICE](NOTICE). A distributor must provide the complete corresponding source for the
exact binaries it ships, including local modifications and the scripts needed to build them.

> [!Caution]
> **Misuse Disclaimer:** <br>
> The developers of VynxDesk do not condone or support unauthorized access, control, or invasion of privacy.


VynxDesk is written in Rust and uses a separately configured rendezvous/relay service for production releases.
The upstream project is available at [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk).
