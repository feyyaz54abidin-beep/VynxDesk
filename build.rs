...
fn build_manifest() {
    ...
    res.set_icon("res/icon.ico")
        .set("FileDescription", "VynxDesk Remote Desktop")
        .set("ProductName", "VynxDesk")
        .set("CompanyName", "VynxDesk Technologies")
        .set("LegalCopyright", "Copyright (C) 2026 VynxDesk Technologies")
        .set("OriginalFilename", "vynxdesk.exe")
...
fn main() {
    println!("cargo:rerun-if-env-changed=VYNXDESK_RENDEZVOUS_SERVER");
    println!("cargo:rerun-if-env-changed=VYNXDESK_RENDEZVOUS_PUB_KEY");
